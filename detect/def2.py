...
def StoI(name):
	...
	return name
#reads all files
happy=read_file("/var/www/html/HappyBox/detect/happy.txt")
sad=read_file("/var/www/html/HappyBox/detect/sad.txt")
angry=read_file("/var/www/html/HappyBox/detect/angry.txt")
fear=read_file("/var/www/html/HappyBox/detect/fear.txt")
surprise=read_file("/var/www/html/HappyBox/detect/surprise.txt")
neg=read_file("/var/www/html/HappyBox/detect/neg.txt")
quant=read_file("/var/www/html/HappyBox/detect/quant.txt")
stops=read_file("/var/www/html/HappyBox/detect/stopwords_en.txt")
hr=read_file("/var/www/html/HappyBox/detect/hr.txt")
sar=read_file("/var/www/html/HappyBox/detect/sar.txt")
fr=read_file("/var/www/html/HappyBox/detect/fr.txt")
ar=read_file("/var/www/html/HappyBox/detect/ar.txt")
sur=read_file("/var/www/html/HappyBox/detect/sur.txt")
hr=StoI(hr)
sar=StoI(sar)
fr=StoI(fr)
ar=StoI(ar)
...
text=open('/var/www/html/HappyBox/detect/word.txt','r')
text=text.read()
result=text
text=text.lower()
text=text.split('\n')
